...
dhcp-range=${cluster_name},192.168.58.100,192.168.58.250,24
dhcp-option=${cluster_name},option:dns-server,192.168.58.100
...
de:ad:be:ff:00:05,openshift-master-0,192.168.58.105
de:ad:be:ff:00:06,openshift-master-1,192.168.58.106
de:ad:be:ff:00:07,openshift-master-2,192.168.58.107
de:ad:be:ff:00:08,openshift-worker-0,192.168.58.108
de:ad:be:ff:00:09,openshift-worker-1,192.168.58.109
de:ad:be:ff:00:10,openshift-worker-2,192.168.58.110
EOF
...
echo "nameserver 192.168.58.100" > /etc/resolv.conf
